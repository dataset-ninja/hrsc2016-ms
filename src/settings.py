...
RELEASE_DATE: Optional[str] = "2022-09-15"  # e.g. "YYYY-MM-DD"
if RELEASE_DATE is None:
    RELEASE_YEAR: int = None

HOMEPAGE_URL: str = "https://www.kaggle.com/datasets/weiming97/hrsc2016-ms-dataset"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 6816639
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/hrsc2016-ms"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = ["https://www.kaggle.com/datasets/weiming97/hrsc2016-ms-dataset"]
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["https://www.mdpi.com/2072-4292/14/21/5460"]
